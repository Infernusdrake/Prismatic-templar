...
func _build() -> void:
	...
	var hint := Label.new()
	hint.text = "WASD Move  |  Space Dodge  |  LMB Attack  |  Tab Lock-on  |  E Execute"
	hint.set_anchor_and_offset(SIDE_LEFT,   0.5, -350)
	hint.set_anchor_and_offset(SIDE_RIGHT,  0.5,  350)
